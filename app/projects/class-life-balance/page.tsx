...
const screenshots = [
  { src: "/demos/class-life-balance/image.png", alt: "Main Interface" },
  { src: "/demos/class-life-balance/Screenshot 2026-01-27 205158.png", alt: "Schedule View" },
  { src: "/demos/class-life-balance/Screenshot 2026-01-27 205339.png", alt: "Task Management" },
  { src: "/demos/class-life-balance/Screenshot 2026-01-27 205507.png", alt: "Analytics" },
];
...
const projectDetails = {
  ...
  categories: ["Productivity", "Planning", "Students"],
  technologies: ["Next.js", "TypeScript", "Tailwind", "PostgreSQL"],
  github: "https://github.com/Dumisani-C/class-life-balance-optimizer",
};

const keyFeatures = [
  "Adaptive schedule planning based on workload and deadlines",
  "Rule-based logic informed by student burnout research",
  "Clean full-stack architecture designed for iteration",
  "Visual analytics for time management insights",
];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="flex gap-2 overflow-x-auto pb-2">
                {screenshots.map((screenshot, i) => (
                  <button key={i} onClick={() => setSelectedImage(i)} className={`relative flex-shrink-0 w-20 h-14 rounded-md overflow-hidden border-2 transition-all ${selectedImage === i ? "border-violet-400" : "border-white/10 hover:border-white/30"}`}>
            ...
            <div className="lg:col-span-2">
              <h1 className="text-2xl font-bold mb-4">Class-Life Balance Optimizer</h1>
              <p className="text-white/70 text-sm leading-relaxed mb-6">
                A data-driven planning system built after my burnout research to help students balance academics, work, and recovery time.
              </p>
              ...
              <a href={projectDetails.github} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-4 py-2 bg-violet-500 hover:bg-violet-400 text-black font-medium rounded-lg transition-colors text-sm">
